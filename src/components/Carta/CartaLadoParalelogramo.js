...
import CartaParalalogramoLado from '../../assets/CartaParalalogramoLado.png';
import { PythagorasCard } from '../../js/cards/pythagorasCard';
import { LadoParalogramo } from '../../js/cards/ladoParalelogramo';

function CartaLadoParalelogramo(props) {
    ...
    const handleDragStart = (e) => {
        ...
        carta = new LadoParalogramo(settings.whiteboard); 
    ...
    return (
        ...
        >
            <img src={CartaParalalogramoLado} className="photo"></img>
        </div>
    );
}

export default CartaLadoParalelogramo;
