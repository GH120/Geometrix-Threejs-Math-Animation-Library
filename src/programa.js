import {Draggable} from './js/inputs/draggable';
import {Hoverable} from './js/inputs/hoverable';
import {MostrarAngulo} from './js/outputs/mostrarAngulo';
import { ColorirIsoceles } from './js/outputs/colorirIsoceles';
import {SenoOnHover, CossenoOnHover, TangenteOnHover} from './js/outputs/trigonometry';
import { MostrarTipo } from './js/outputs/mostrarTipo';
import  MoverVertice  from './js/outputs/moverVertice';
import Circle from './js/objetos/circle';
import * as THREE from 'three'
import Circunscrever from './js/animacoes/circunscrever';
import { MostrarBissetriz } from './js/outputs/mostrarBissetriz';
import { Clickable, MultipleClickable } from './js/inputs/clickable';
import FixarAoCirculo from './js/outputs/fixarAoCirculo';
